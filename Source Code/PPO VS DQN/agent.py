# This code is not ours. It was first used by the source below. 
# https://github.com/Sourish07/Super-Mario-Bros-RL/blob/main/agent.py
# Aryan Miriyala and Cedric Dortch.

# We are defining the agent in this file
# We are defining the actual algorithm here as well, we defining the learning rate, episode decay, learning rate and many other parameters here.
